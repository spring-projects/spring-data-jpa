...
public class Specifications<T> implements Specification<T>, Serializable {
	 ...
	 * @since 1.6
	 */
	static class NegatedSpecification<T> implements Specification<T>, Serializable {
	 ...
	 * @since 1.6
	 */
	static class ComposedSpecification<T> implements Specification<T>, Serializable {
