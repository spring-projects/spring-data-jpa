	...
	private class PredicateBuilder {
		...
		public Predicate build() {
			...
			switch (type) {
				...
				case NOT_IN:
					return upperIfIgnoreCase(getTypedPath(root, part)).in(provider.next(part, Collection.class).getExpression()).not();
				case IN:
					return upperIfIgnoreCase(getTypedPath(root, part)).in(provider.next(part, Collection.class).getExpression());
				case STARTING_WITH:
				case ENDING_WITH:
				case CONTAINING:
				case NOT_CONTAINING:
