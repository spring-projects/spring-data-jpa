 ...
 * @since 3.1
 */
class Hibernate62HqlQueryTransformer extends Hibernate62HqlQueryRenderer {
	...
	Hibernate62HqlQueryTransformer() {
		this(Sort.unsorted(), false, null);
	}

	Hibernate62HqlQueryTransformer(Sort sort) {
		this(sort, false, null);
	}

	Hibernate62HqlQueryTransformer(boolean countQuery, @Nullable String countProjection) {
		this(Sort.unsorted(), countQuery, countProjection);
	}

	private Hibernate62HqlQueryTransformer(Sort sort, boolean countQuery, @Nullable String countProjection) {
