...
import static org.springframework.data.jpa.repository.aot.StringAotQuery.jpqlQuery;
...
class JpaCodeBlocksUnitTests {
	...
	void appliesLockModeIfPresent() throws NoSuchMethodException {
		...
		CodeBlock codeBlock = initQuyerBuilder()
	...
	QueryBlockBuilder initQuyerBuilder() throws NoSuchMethodException {
