...
/**
 * Verify that {@link JpaSort#unsafe(String...)} works properly with JPQL on EclipseLink.
 *
 * @author Greg Turnquist
 */
@ExtendWith(SpringExtension.class)
@ContextConfiguration({ "classpath:application-context.xml", "classpath:eclipselink.xml" })
@Transactional
@HidePersistenceProviders({ PersistenceProvider.HIBERNATE, PersistenceProvider.ECLIPSELINK })
class JpaSortUnsafeJpqlOnEclipseLinkTests {
