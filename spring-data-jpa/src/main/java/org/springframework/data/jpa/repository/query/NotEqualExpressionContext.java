...
/**
 * Represents a {@literal <>} clause in a query.
 * 
 * @author Greg Turnquist
 */
class NotEqualExpressionContext implements ExpressionContext {

	private final ExpressionContext left;
	private final ExpressionContext right;

	public NotEqualExpressionContext(ExpressionContext left, ExpressionContext right) {
