...
public class JpaQueryMethod extends QueryMethod {
	...
	/**
	 * @see <a href=
	 *      "https://jakarta.ee/specifications/persistence/3.1/jakarta-persistence-spec-3.1.pdf">Jakarta
	 *      Persistence 3.1 Specification: 2.2 Persistent Fields and Properties - Paragraph
