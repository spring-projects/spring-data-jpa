...
abstract class QueryParameterSetterFactory {
	 ...
	 * @return
	 */
	abstract @Nullable QueryParameterSetter create(ParameterBinding binding, StructuredQuery parametrizedQuery);
	...
	private static class ExpressionBasedQueryParameterSetterFactory extends QueryParameterSetterFactory {
		...
		@Override
		public @Nullable QueryParameterSetter create(ParameterBinding binding, StructuredQuery parametrizedQuery) {
	...
	private static class SyntheticParameterSetterFactory extends QueryParameterSetterFactory {
		...
		@Override
		public @Nullable QueryParameterSetter create(ParameterBinding binding, StructuredQuery query) {
