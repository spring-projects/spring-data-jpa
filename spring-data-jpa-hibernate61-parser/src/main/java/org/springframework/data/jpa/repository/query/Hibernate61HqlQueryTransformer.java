 ...
 * @since 3.1
 */
class Hibernate61HqlQueryTransformer extends Hibernate61HqlQueryRenderer {
	...
	Hibernate61HqlQueryTransformer() {
		this(Sort.unsorted(), false, null);
	}

	Hibernate61HqlQueryTransformer(Sort sort) {
		this(sort, false, null);
	}

	Hibernate61HqlQueryTransformer(boolean countQuery, @Nullable String countProjection) {
		this(Sort.unsorted(), countQuery, countProjection);
	}

	private Hibernate61HqlQueryTransformer(Sort sort, boolean countQuery, @Nullable String countProjection) {
